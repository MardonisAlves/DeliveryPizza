 ...
 */
class Cardapio extends \App\Model\Cardapio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'Id', 'name', 'descricao', 'tamanho', 'url_image', 'preco', 'date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cardapio $proxy) {

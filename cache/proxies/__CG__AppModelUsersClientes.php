 ...
 */
class UsersClientes extends \App\Model\UsersClientes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'users', 'id', 'cidade', 'rua', 'numero', 'bairro', 'referencia', 'telefone'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsersClientes $proxy) {
